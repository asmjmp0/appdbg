...
interface IInterceptor {
    ...
    fun methodCalled(uuid:String,className:String,instance:Any? ,funcName:String, signature: String,param:Array<out Any?>): Any?
    fun ioResolver(path: String):ImplStatus
}